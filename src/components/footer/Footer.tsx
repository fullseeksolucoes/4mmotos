            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-sm text-muted">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="https://www.instagram.com/4mmotos/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                                    Instagram
                                </Link>
                            </li>
                            <li>
                                <Link href="https://www.facebook.com/4mmotos/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                                    Facebook
                                </Link>
                            </li>
                            <li>
                                <Link href="https://wa.me/5532999999999" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                                    WhatsApp
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted">
                    <p className="text-center md:text-left max-w-3xl leading-relaxed">
                        © {new Date().getFullYear()} 4M Motos Workshop | Desenvolvido por{" "}
                        <Link
